...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Actualizar datos del doctor</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="card card-success">
                        ...
                        <div class="card-body">
                            <!--formulario-->
                            <form action="../app/controllers/doctores/updateDoctor.php" method="post">
                                <div class="card-body">
                                    <!--fila_01-->
                                    <div class="row ">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control"
                                            value="<?php echo $tel;?>" name="tel" placeholder="Telefono">
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-5">
                                            ...
                                            <input type="text" class="form-control"
                                              value="<?php echo $email;?>" name="email" placeholder="E-Mail">
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" 
                                            value="<?php echo $direc;?>" name="direc" placeholder="Direccion">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <input type="text" class="form-control" 
